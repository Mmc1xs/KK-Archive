      ...
      <section className="panel">
        <div className="panel-header">
          <div>
            ...
            <p className="muted">
              Process content that still has a Telegram download source but does not yet have a website download file.
            </p>
          </div>
      ...
      <section className="panel">
        <div className="split">
          <div>
            ...
            <h2 className="title-lg">Telegram to R2 Demo</h2>
          </div>
              ...
              <article key={content.id} className="admin-activity-card">
                <div className="split">
                  ...
                  <span className={getStatusClassName(content.siteDownloadDemo?.status)}>
                    {getStatusLabel(content.siteDownloadDemo?.status)}
                  </span>
                </div>
