    ...
    <div className="grid">
      <section className="panel">
        <div className="panel-header">
          <div>
            ...
            <p className="muted">
              Inspect TG media from the source link, choose the correct file, and upload directly to R2 without
              saving a local copy.
            </p>
          </div>
          <div className="inline-actions">
            ...
            {canIgnoreContent ? (
              <form action={ignoreSiteDownloadDemoAction}>
                <input type="hidden" name="contentId" value={content.id} />
                <input type="hidden" name="redirectTo" value={`/admin/site-download-demo/${content.id}`} />
                <button type="submit" className="button site-download-ignore-button">
                  Mark Ignore
                </button>
              </form>
            ) : null}
        ...
        <div className="admin-stats-grid">
          ...
          <article className="admin-stat-card">
            ...
            <small>{content.telegramSourceUrl ? "TG source detected" : "No TG source link"}</small>
          </article>
        </div>
        ...
        <div className="grid site-download-demo-meta-grid">
          <div className="admin-activity-card">
            ...
            <div className="muted">TG source</div>
            {content.telegramSourceUrl ? (
              <div className="inline-actions">
                <a href={buildTelegramAppHref(content.telegramSourceUrl)} className="link-pill">
                  Open in TG App
                </a>
              ...
              <div className="muted">This content does not have a TG source download link.</div>
            )}
            {content.telegramSourceUrl ? <small>{content.telegramSourceUrl}</small> : null}
          </div>
          <div className="admin-activity-card">
      ...
      {canUploadMore ? (
        <section className="panel">
          <div className="panel-header">
            <div>
              <div className="eyebrow">TG Candidates</div>
          ...
          {!inspectError && !resolvedLinks.length ? (
            <div className="notice">No matching TG download link was found inside the source message.</div>
          ) : null}
